const HowItWorks = () => {
  return (
    <section className="self-stretch w-full relative items-start px-[50px] sm:px-[80px] py-[50px] flex justify-center bg-[#ECEDFF]">
      <div className="flex-1 self-stretch min-[2000px]:h-screen flex flex-col gap-[45px] items-start w-full">
        ...
        <div className="flex flex-col">
          <div className="w-full flex items-center justify-center self-stretch flex-1 border-l border-[#4E7FFF] sm:gap-[25px]">
            <div className="bg-[#fff] rounded-full relative right-5 sm:right-6 w-[40px] h-[40px] sm:w-[50px] sm:h-[50px] p-[6px] sm:p-[10px]">
            ...
            <div className="block sm:flex items-center justify-center gap-[35px] py-[16px] sm:py-0">
              ...
              <div>
                <h1 className="sm:w-full max-w-[440px] w-[200px] min-w-[240px] font-karla text-[18px] sm:text-[20px] font-bold leading-[130%] min-[2000px]:text-[40px] sm:leading-[120%] text-start tracking-[-0.78px] sm:text-[#004EB7] text-[#003855] self-stretch">
          ...
          <div className="w-full flex items-center self-stretch flex-1 border-l border-[#4E7FFF] sm:gap-[25px]">
            ...
            <div className="block sm:flex items-center justify-center gap-[35px] py-[16px] sm:py-0">
              ...
              <div>
                <h1 className="sm:w-full min-[2000px]:text-[40px]  max-w-[440px] w-[200px] min-w-[240px] font-karla text-[18px] sm:text-[20px] font-bold leading-[130%] sm:leading-[120%] text-start tracking-[-0.78px] sm:text-[#004EB7] text-[#003855] self-stretch">
                  Escrow Creation
                  <p className="text-base text-[#003855] font-[400] leading-normal self-stretch pt-[16px]">
