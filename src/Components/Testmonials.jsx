...
const Testmonials = () => {
  return (
    <section className="hidden self-stretch w-full relative py-[50px] min-[2000px]:py-[120px] sm:flex flex-col bg-[#ECEDFF]">
      <div className="self-stretch flex flex-col gap-[30px] items-center">
        <h1 className="w-full font-karla px-6 md:px-12 text-[27px] tracking-[-0.5px] md:tracking-[-0.78px] leading-[120%] font-bold text-[#003855] min-[2000px]:text-[40px]">
