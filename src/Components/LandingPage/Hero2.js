...
const Hero2 = () => {
  return (
      <section className="self-stretch bg-[url(/images/Frame19.svg)] bg-no-repeat bg-cover flex flex-col items-start px-6 md:px-12 py-[50px] box-border gap-[10px] w-full font-manrope ">
        <div className="self-stretch flex flex-col gap-[60px] items-start w-full min-[2000px]:py-[120px]">
          <h1 className="w-full min-[2000px]:text-[40px] font-karla text-[27px] tracking-[-0.5px] md:tracking-[-0.78px] leading-[120%] font-bold">
