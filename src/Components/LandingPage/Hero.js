const Hero = () => {
  return (
    <section className="Hero w-full md:aspect-[721/512] min-[2000px]:bg-cover min-[2000px]:p-[120px] min-[2000px]:aspect-[16/6] md:h-auto h-[513px] max-h-full bg-[url(/images/Hero.jpg)] bg-no-repeat bg-cover bg-center grid grid-cols-1 md:grid-cols-2 px-6 md:px-12 pt-[31px] sm:pt-[85px] box-border font-karla ">
      <div className="self-stretch flex flex-col items-start gap-[20px] max-w-full">
        <h1 className="self-stretch min-[2000px]:text-[80px] relative w-full font-[inherit] sm:text-[40px] text-[30px] text-[#BEC6FF] font-bold sm:font-[500] tracking-[-0.58px] sm:tracking-[-1px] leading-[120%] sm:leading-[100%]">
          Explore a World of
        ...
        <p className="w-full min-[2000px]:text-2xl self-stretch font-karla leading-normal sm:leading-[130%] text-[#FFF] font-[400] text-base sm:text-[18px]">
          ...
          is transparent, <br /> every car has a story, and every deal is sealed with
          trust.
        </p>
