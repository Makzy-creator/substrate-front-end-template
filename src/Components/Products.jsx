...
const Products = () => {
  return (
    <section className="self-stretch flex flex-col items-start gap-[40px] sm:gap-[10px] bg-[#ECEDFF] w-full px-6 md:px-12 py-[50px] ">
      <div className="self-stretch flex flex-col w-full items-start gap-[40px] sm:gap-[60px] min-[2000px]:py-[120px]">
        <div className="flex max-sm:flex-col gap-2 justify-between sm:items-center w-full">
          <h1 className=" font-karla min-[2000px]:text-[40px] text-[#003855] text-[27px] tracking-[-0.5px] md:tracking-[-0.78px] leading-[120%] font-bold">
